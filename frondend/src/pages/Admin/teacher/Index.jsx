...
import { getAllTeacher } from '../../../api/admin/manageTeacherService';
...
const COLUMN_CONFIG = {
  'full_name': {
    header: 'Họ và Tên', // Đổi header cho phù hợp
    type: 'text'
  },
  'bio': {
    header: 'Tiểu sử', // Thêm cột Bio
    type: 'text',
  },
};
...
function Index() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const { data: apiResponse, error: apiError } = await getAllTeacher(currentPage, pageSize);
