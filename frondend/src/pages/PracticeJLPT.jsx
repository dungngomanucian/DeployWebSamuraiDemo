...
      {/* 1. Hero Section - Luyện đề JLPT (CĂN LỀ TRÁI) */}
      <section className="relative w-full bg-[#E9EFFC]">
        {/* background image (subtle), not slideshow */}
        <img 
            src={heroBg} 
            alt="bg" 
...
                BỨT PHÁ JLPT: Nắm chắc điểm số với kho đề thi phân loại.
            </h2>
          <p className="text-[#0B1320] max-w-3xl text-base md:text-lg mb-8">
            Luyện nhuần nhuyễn từng kỹ năng, sẵn sàng chinh phục JLPT.
          </p>
            
            {/* Nút Khám phá ngay */}
          <button 
...
      </section>
      ...
      {/* 2. Practice modes - CHẾ ĐỘ LUYỆN THI (ĐÃ SỬA PADDING VÀ MARGIN) */}
      <section id="che-do-luyen-thi" className="w-full bg-white pt-14 pb-0">
        <div className="max-w-6xl mx-auto px-4 text-center">
          {/* Sửa cỡ chữ và ngắt dòng của tiêu đề */}
          <h2 className="text-3xl md:text-4xl font-bold text-[#0B1320] mb-12">
            THỰC CHIẾN JLPT VỚI <br /> CÁC CHẾ ĐỘ LUYỆN THI
          </h2>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
            
                {/* Card 1: Luyện tập theo dạng bài */}
...
                </div>
              ...
              <p className="text-[#5B6476] text-sm mb-6 leading-relaxed max-w-md">
                ...
                <a href="/practice-by-type" className="btn rounded-full bg-[#4169E1] hover:bg-[#365AAB] text-white border-none text-base font-medium px-8 h-[44px]">
                  Xem chi tiết
                </a>
            </div>

            {/* Card 2: Mô phỏng thi thật */}
            <div className="bg-white rounded-[16px] p-8 shadow-xl border border-gray-100 flex flex-col items-center text-center transition-all duration-300 hover:shadow-2xl hover:scale-[1.02]">
                <div className="w-[64px] h-[64px] bg-[#E9EFFC] rounded-md mb-6 flex items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8 text-[#4169E1]">
...
                Ngữ pháp – Từ vựng có thời gian làm bài riêng, và sau khi chuyển 
                sang phần tiếp theo, sẽ không thể quay lại chỉnh sửa đáp án.
              </p>
                <a href="/mock-exam-jlpt" className="btn rounded-full bg-[#4169E1] hover:bg-[#365AAB] text-white border-none text-base font-medium px-8 h-[44px]">
                Xem chi tiết
              </a>
            </div>
          </div>
          
          {/* Đường kẻ ngang (Điều chỉnh mt để sát hơn) */}
