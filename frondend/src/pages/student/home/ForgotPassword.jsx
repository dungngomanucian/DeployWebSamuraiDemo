...
const ForgotPasswordForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Gửi yêu cầu đặt lại mật khẩu (demo)
    console.log("Gửi yêu cầu quên mật khẩu cho:", formData.email);

    toast.success("Đã gửi liên kết đặt lại mật khẩu đến Gmail của bạn!");
  };
